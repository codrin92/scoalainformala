...
print(D().info())   #Ordinea: Se iau parintii directi de la stanga la dreapta. Daca nu se gaseste metoda, atunci se iau parintii parintilor, de la stanga la dreapta